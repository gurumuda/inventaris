...
--
-- Dumping data for table `tb_obrolan`
--

INSERT INTO `tb_obrolan` (`id_`, `id_user`, `pesan`, `waktu`) VALUES
(1, '00039', 'Selamat datang di aplikasi manajemen barang SMA negeri 1 jorong', '2020-04-01 12:04:53');
...
CREATE TABLE `tb_pengguna` (
  ...
  `status` enum('1','0') NOT NULL COMMENT '1 = aktif, 0 = non aktif',
  `level` enum('1','2','3','4','5','6','7','8','10','11','12','100') NOT NULL COMMENT '100 = Admin, 1 = kepsek, 2 = wakasek, 3 = kepala TU, 4 = kpl lab, 5 = kpl perpus, 6 = pengelola lab, 7 = wali kelas, 8 = guru, 10 = BK, 11 = UKS , 12 = OSIS'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, '00001', 'Alvian Septyayuwandianto, S.Pd', 'yuwandianto@gmail.com', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '6'),
(2, '00002', 'Ani Rustyawatie, S.Pd', 'ani@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '6'),
(3, '00003', 'Anwar Rosyid, S.Pd', 'anwar@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '2'),
(4, '00004', 'Arbayah, S.Pd', 'arbayah@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '6'),
(5, '00005', 'Bandan Yurisman, S.Pd', 'bandan@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '6'),
(6, '00006', 'Bekti Priyantini, S.Pd', 'bekti@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '7'),
(7, '00007', 'Diana, S.Pd', 'diana@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '8'),
(8, '00008', 'Dra. Siti Mahmudah', 'mahmudah@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '8'),
(9, '00009', 'Dra. Sriamin', 'sriamin@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '8'),
(10, '00010', 'Drs. Misunu', 'misunu@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '8'),
(11, '00011', 'Erika Siti Farida, S.Pd.I', 'erika@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '7'),
(12, '00012', 'Fahrian Hefni, S.Pd', 'fahrian@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '8'),
(13, '00013', 'Farid Syuhada, S.Pd', 'farid@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '7'),
(14, '00014', 'Fitria Kusuma Noor, S.Pd', 'fitria@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '7'),
(15, '00015', 'Fitriansyah, S.Pd', 'fitriansyah@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '7'),
(16, '00016', 'Heri Setiono, S.Pd', 'heri@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '7'),
(17, '00017', 'Kariyati, M.Pd', 'kariyati@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '4'),
(18, '00018', 'M. Rija Pahtiyansa, S.Pd', 'rija@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '7'),
(19, '00019', 'Maria Ulfah, S.Pd', 'maria@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '7'),
(20, '00020', 'Marliana, S.Pd', 'marliana@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '6'),
(21, '00021', 'Mulyana, S.Pd', 'mulyana@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '7'),
(22, '00022', 'Munirah Hayanti, S.Pd', 'munirah@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '7'),
(23, '00023', 'Norhapika, S.Pd', 'norhapika@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '7'),
(24, '00024', 'Nur Rahmah, S.Pd', 'rahmah@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '8'),
(25, '00025', 'Patmawatina, S.Pd', 'patmawatina@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '7'),
(26, '00026', 'Qonitah, S.Pd', 'qonitah@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '2'),
(27, '00027', 'Raisah, S.Pd', 'raisah@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '11'),
(28, '00028', 'Saridi, S.Pd', 'saridi@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '7'),
(29, '00029', 'Saryanta, S.Pd', 'saryanta@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '7'),
(30, '00030', 'Setyo Widayanto, S.Sn', 'setyo@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '7'),
(31, '00031', 'Siamus Fifah A W, S.Pd', 'siamus@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '7'),
(32, '00032', 'Siti Asiyah, S.Pd', 'asiyah@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '7'),
(33, '00033', 'Sufianor, S.Pd.I', 'sufianor@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '7'),
(34, '00034', 'Suyanto, S.Pd', 'suyanto@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '8'),
(35, '00035', 'Syahrian, S.Pd', 'syahrian@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '2'),
(36, '00036', 'Tumija, S.Pd', 'tumija@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '5'),
(37, '00037', 'Yesi Erawati, S.Pd', 'yesi@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '7'),
(38, '00038', 'Yurniati, S.Pd', 'yurniati@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '6'),
(39, '00039', 'Administrator', 'admin@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '100'),
(40, '00040', 'Haryadi, S.Pd', 'haryadi@sch.id', '$2y$10$.MzSul3IMcpa8Gvn.e/mSea7MbeqTV8XfmoItgRhJJcjp7/C.NIcO', '1', '1'),
(41, '00041', 'Widiasih', 'widi@sch.id', '$2y$10$FaozDR.pJUbqXfmzLSlgx.2jt40/stV/j.YdUTtIrqK/UH6RkuC2K', '1', '3'),
(42, '00042', 'Maya Lisna', 'maya@sch.id', '$2y$10$vMVZUUoe/cn4jpThoSWtpespKa9lCJM5rCEgvBnyCBSoS9ka7pP36', '1', '8');
...
(5, '6', '1', 'R0005', 'Ruang Laboratorium Biologi', '00002'),
...
(9, '6', '5', 'R0009', 'Ruang Laboratorium Komputer', '00001'),
...
(14, '7', '', '10ips1', 'Ruang kelas 10 IPS 1', '00025'),
...
(3, '00002', 'Bola Voli', '12', '650000', '7800000', 'Pembelajaran dan Ekstrakurikuler', '0'),
(4, '00001', 'Bola Basket', '12', '450000', '5400000', 'Pembelajaran ', '3'),
(5, '00001', 'Net bola voli', '2', '400000', '800000', 'Pembelajaran dan Ekstrakurikuler', '1'),
(6, '00001', 'Jaring gawang futsal', '2', '700000', '1400000', 'Pembelajaran dan ekstrakurikuler', '2'),
(7, '00001', 'Papan pengumuman', '1', '1000000', '1000000', 'Kegiatan osis', '3');
...
--
ALTER TABLE `tb_snp`
  MODIFY `id_` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=305;
