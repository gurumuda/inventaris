...
<style>
    ...
    @page {size: portrait;}
        ...
        <div class="card-body">
            <h4 class="card-title text-center">KONDISI SARANA SEKOLAH <br> TAHUN 2020 BERDASARKAN PERATURAN MENTERI PENDIDIKAN NASIONAL <br> NOMOR 4 TAHUN 2007</h4>
            <hr>
            <div class="table-responsive">
                <table id="zero_config" class="table table-bordered" border="all" style="border-collapse: collapse;">
                    <thead>
                        <tr>
