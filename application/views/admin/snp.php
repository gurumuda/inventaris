...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h4>SNP Ruang Kepala Sekolah</h4>
                    </div>
                    <div class="card-body">
        ...
        <div class="card">
            <div class="card-header">
                <h4>SNP Ruang Wakil Kepala Sekolah</h4>
            </div>
            <div class="card-body">
...
<div class="card">
    <div class="card-header">
        <h4>SNP Ruang Kepala Lab / Perpus</h4>
    </div>
    <div class="card-body">
